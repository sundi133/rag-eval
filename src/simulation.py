...
def simulation_task(
    ...
    try:
        ...
        evaluation_query = db.session.query(Assessments).filter(
            Assessments.simulation_id == simulation_id,
        ...
        simulation_query = db.session.query(EvaluationProfiles).filter(
